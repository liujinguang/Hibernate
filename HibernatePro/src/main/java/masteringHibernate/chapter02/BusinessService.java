...
public class BusinessService {
	private String dbUrl = "jdbc:mysql://localhost:3306/db_hibernate";
	private String dbUser = "root";
	private String dbPwd = "infinera";
	...
	public void deleteCustomer(Customer customer) throws Exception {
		...
		try {
			...
			stmt = con.prepareStatement("delete from ORDERS where " + "CUSTOMER_ID=?");
	...
	public List findCustomerByName(String name) throws Exception {
		...
		try {
			...
			String sqlString = " select c.ID CUSTOMER_ID,c.NAME,c.AGE,o.ID ORDER_ID, " + "o.ORDER_NUMBER,o.PRICE "
					+ "from CUSTOMERS c left outer join ORDERS o " + "on c.ID =o.CUSTOMER_ID where c.NAME=?";
